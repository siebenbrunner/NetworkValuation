...
function [vecP,vecEquity] = calcElsinger(vecE,matL,matTheta)
...
while blnLoop
    ...
    vecAux = matPi'*vecP+vecE+matTheta'*vecEquity;
    ...
    if numIterations>numMaxIterations
        blnLoop=false;
        disp('No convergence in calcElsinger');
    end
